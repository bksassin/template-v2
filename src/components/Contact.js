    ...
    <div class="-mx-4 flex flex-wrap lg:justify-between">
      <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div class="mb-12 max-w-[570px] lg:mb-0">
          <span class="lg:text-base mb-4 block font-semibold text-[#eab308]">
            Contact Us
          </span>
          <h2
            class="text-dark mb-6 text-lg font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
          >
            Estimate or Questions
          </h2>
          <p class="text-body-color mb-9 text-sm lg:text-base leading-relaxed">
          Questions or need an estimate? Contact us today for quality workmanship and exceptional customer service. Get in touch now to discuss your home repair needs.
          </p>
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              <h4 class="text-dark mb-1 text-base lg:text-xl font-bold">Our Location</h4>
              <p class="text-body-color text-sm lg:text-base">
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              <h4 class="text-dark mb-1 text-base lg:text-xl font-bold">Phone Number</h4>
              <p class="text-body-color text-sm lg:text-base">(+62)81 414 257 9980</p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div class="w-full">
              <h4 class="text-dark mb-1 text-base lg:text-xl font-bold">Email Address</h4>
              <p class="text-body-color text-sm lg:text-base">info@yourdomain.com</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <form>
            <div class="mb-6">
              <input
                ...
                class="text-body-color border-[f0f0f0] focus:border-primary w-full rounded border py-3 px-[14px] text-sm outline-none focus-visible:shadow-none"
              />
            </div>
            <div class="mb-6">
              <input
...
<select name="cars" id="cars">
  <option value="volvo">Renovation</option>
  <option value="saab">Unfinished Projects</option>
  ...
  <textarea
    ...
    class="text-body-color border-[f0f0f0] focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-sm outline-none focus-visible:shadow-none"
  ></textarea>
</div>
<div class="mb-6">
  <label class="inline-flex items-center">
    <input type="checkbox" class="form-checkbox h-5 w-5 text-primary" name="call-scheduled" value="yes" />
    <span class="ml-2 text-sm text-body-color">Would you like a call scheduled?</span>
  </label>
</div>
<div>
  <button
